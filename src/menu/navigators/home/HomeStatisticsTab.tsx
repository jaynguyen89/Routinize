...
import PersonalStatisticsStack from "./PersonalStatisticsStack";
import SharedStatisticsStack from "./SharedStatisticsStack";
...
const HomeStatisticsTab = (props : any) => {
    return (
        props.settings &&
        <BottomTab.Navigator
            screenOptions={
        ...
        >
            <BottomTab.Screen name='Personal' component={ PersonalStatisticsStack } options={{ tabBarBadge : 1 }} />
            <BottomTab.Screen name='Shared' component={ SharedStatisticsStack } />
        </BottomTab.Navigator>
        || <></>
    );
}
