...
import PersonalDoneTodosStack from "./PersonalDoneTodosStack";
import SharedDoneTodosStack from "./SharedDoneTodosStack";
...
const DoneTodoTab = (props : any) => {
    return (
        ...
        >
            <BottomTab.Screen name='Personal' component={ PersonalDoneTodosStack } options={{ tabBarBadge : 1 }} />
            <BottomTab.Screen name='Shared' component={ SharedDoneTodosStack } />
        </BottomTab.Navigator>
        || <></>
    );
}
