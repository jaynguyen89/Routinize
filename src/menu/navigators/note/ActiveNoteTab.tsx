...
import PersonalActiveNotesStack from "./PersonalActiveNotesStack";
import SharedActiveNotesStack from "./SharedActiveNotesStack";
...
const ActiveNoteTab = (props : any) => {
    return (
        ...
        >
            <BottomTab.Screen name='Personal' component={ PersonalActiveNotesStack } options={{ tabBarBadge : 1 }} />
            <BottomTab.Screen name='Shared' component={ SharedActiveNotesStack } />
        </BottomTab.Navigator>
        || <></>
    );
}
